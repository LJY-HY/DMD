...
def main():
    ...
    training = ''
    path = './checkpoint/'+args.arch+'_'+args.dataset+'_freeze_'+args.optimizer+'_'+str(args.freeze)+'.pth'
    result = './checkpoint/'+args.arch+'_'+args.dataset+'_freeze_'+args.optimizer+'_'+str(args.freeze)+'.txt'
